...
public class dong_nae_life_reply_update extends AppCompatActivity {
    ImageView dong_nae_life_reply_update_imageview;
    EditText dong_nae_life_reply_content_update_edittext;
    ImageButton dong_nae_life_reply_update_cancle_imagebutton, dong_nae_life_reply_update_imagebutton;
    Button dong_nae_life_reply_update_button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dong_nae_life_reply_update);
...
//        time = simpleDateFormat.format(date);
        ...
        dong_nae_life_reply_update_imageview = (ImageView) findViewById(R.id.dong_nae_life_reply_update_imageview);
        dong_nae_life_reply_content_update_edittext = (EditText) findViewById(R.id.dong_nae_life_reply_content_update_edittext);
        dong_nae_life_reply_update_cancle_imagebutton = (ImageButton) findViewById(R.id.dong_nae_life_reply_update_cancle_imagebutton);
        dong_nae_life_reply_update_imagebutton = (ImageButton) findViewById(R.id.dong_nae_life_reply_update_imagebutton);
        dong_nae_life_reply_update_button = (Button) findViewById(R.id.dong_nae_life_reply_update_button);



        Intent intent = getIntent();
        int update_idx = intent.getIntExtra("update_idx", 0);
        String comment_content = intent.getStringExtra("content");

        System.out.println(comment_content+"comment_content"+update_idx);
...
//                } else if (image == null && update_comment_content.length() == 0) {
//                    dong_nae_life_comment_update(update_idx, null, null, time);
//                }
//                else {
