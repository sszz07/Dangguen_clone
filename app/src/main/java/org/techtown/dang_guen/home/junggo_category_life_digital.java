...
public class junggo_category_life_digital extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_life_digital);
...
//                //int형일때는 == 이것을 사용하지만 String형태일때는 이퀄스를 사용한다
                if (SharedPreferences_phone.equals(phone)) {
                    ...
                    Intent intent = new Intent(junggo_category_life_digital.this, product_my_select.class);
                    ...
                    Intent intent = new Intent(junggo_category_life_digital.this, product_other_select.class);
                    intent.putExtra("idx", idx);
                    intent.putExtra("subject", subject);
                    intent.putExtra("content", content);
                    intent.putExtra("price", price);
    ...
    private void junggo_category_gagu_recycerview_select(String 생활가전) {
        product_ApiInterface ApiInterface = product_ApiClient.getClient().create(product_ApiInterface.class);
        Call<List<product_data>> call = ApiInterface.junggo_category_recycerview_select(생활가전);
    ...
    private void onGetResult(List<product_data> lists) {
        adapter = new home_adapter(junggo_category_life_digital.this, lists, itemClickListener);
    ...
    public void onResume() {
        super.onResume();
        String 생활가전 = "생활가전";
        recyclerView = (RecyclerView) findViewById(R.id.junggo_category_life_digital_recyclerview);

        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.addItemDecoration(new DividerItemDecoration(this, DividerItemDecoration.HORIZONTAL));

        junggo_category_gagu_recycerview_select(생활가전);
    }
}