...
public class my_dang_guen_fragment_complete extends Fragment {
    RecyclerView recyclerView;
    my_dang_guen_fragment_complete_adapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dialog.setContentView(R.layout.my_dang_guen_fragment_complete_dialog);

        view = inflater.inflate(R.layout.fragment_my_dang_guen_complete_fragment, container, false);
        user_image();
        /*
         *SharedPreferences
        ...
        my_dang_guen_fragment_complete_recycerview_select(SharedPreferences_phone);

        itemClickListener = new my_dang_guen_fragment_complete_adapter.ItemClickListener() {
            @Override
...
//                //int형일때는 == 이것을 사용하지만 String형태일때는 이퀄스를 사용한다
    ...
    public void onResume() {
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.my_dang_guen_fragment_complete_recyclerview);
    ...
    private void my_dang_guen_fragment_complete_recycerview_select(String phone) {
        product_ApiInterface ApiInterface = product_ApiClient.getClient().create(product_ApiInterface.class);
        Call<List<product_data>> call = ApiInterface.my_dang_guen_fragment_complete_recycerview_select(phone);
    ...
    private void onGetResult(List<product_data> lists) {
        adapter = new my_dang_guen_fragment_complete_adapter(getActivity(), lists, itemClickListener,dialog_delete,dialog);
