...
public interface my_dang_guen_info_ApiInterface {
    ...
    Call<my_dang_guen_data> my_dang_guen_user_info_select(@Field("phone") String phone
    );

    @FormUrlEncoded
    @POST("user_update.php")
        //@Field을 하는이유는 서버에서 잘 받아와야 되기 때문이다
    Call<my_dang_guen_data> my_dang_guen_user_info_update(@Field("nick") String nick,
    ...
    Call<List<my_dang_guen_data>> my_dang_guen_like_select(
            @Query("like_phone") String like_phone,
            @Query("button_name") String button_name
    );
}
